...
def clock_bana(ghantaa, minutee, secondd, kalam): #function with 4 parameters
...
while True:
    ...
    clock_bana(ghantaa, minutee, secondd, kalam) #calling the ghanta_bana() function with the given parameters
